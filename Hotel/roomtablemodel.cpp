...
bool RoomTableModel::setHeaderData(int section, Qt::Orientation orientation, const QVariant &value, int role)
{
...
bool RoomTableModel::insertColumns(int column, int count, const QModelIndex &parent)
{
...
bool RoomTableModel::removeColumns(int column, int count, const QModelIndex &parent)
{
